...
function willYouMarryMe(isPositiveAnswer) {
  ...
  if (!isPositiveAnswer && typeof isPositiveAnswer === 'boolean') return Promise.resolve('Oh no, she said "No".');
...
function chainPromises(array, action) {
  return processAllPromises(array).then((item) => item.reduce(action)).catch((err) => err);
}
